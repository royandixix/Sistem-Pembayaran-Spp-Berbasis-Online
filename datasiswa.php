...
<body id="page-top">
	...
	<div class="card-header">
		<a href="tambah_siswa.php" class="btn btn-primary btn-icon-split">
	...
	<div class="table-responsive">
        <table class="table table-bordered" cellspacing="0">
                                    ...
                                    <?php
                                        $no = 1;
                                        $tampil = mysqli_query($koneksi, "select * from siswa,spp where siswa.id_spp=spp.id_spp order by nama ASC");
                                    ...
                                    ?>
	                                        <tr>
                                                ...
                                                <td>
                                                    <a href="edit_siswa.php?hal=edit&nis=<?= $data['nis'] ?>" class="btn btn-warning">
                                                    <i class="fa fa-pen mr-2"></i>Edit
                                                    </a>
                                                </td>
                                                <td>
                                                <a href="datasiswa.php?hal=hapus&nis=<?= $data['nis'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data ini?')" class="btn btn-danger">

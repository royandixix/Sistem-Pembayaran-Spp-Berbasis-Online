<?php
    ...
    include 'koneksi.php';
    $tampil = mysqli_query($koneksi, "select * from siswa,spp where siswa.id_spp=spp.id_spp AND nis='$nis'");
    $data = mysqli_fetch_array($tampil);

    if(isset($_POST['simpan'])){
        $simpan = mysqli_query($koneksi, "insert into pembayaran (id_pembayaran, nis, tgl_bayar, bulan_dibayar, tahun_dibayar, id_spp, jumlah_bayar)
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form  method="post">
                ...
                <input name="id_pembayaran"  value="<?= $data['id_spp'] ?>" type ="hidden" class="form-control" required>
                <input name="id_spp"  value="<?= $data['id_spp'] ?>" type ="hidden" class="form-control" required>
                    <label>NIS</label>
                    <input readonly  value="<?= $nis ?>" type ="text" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="tgl_bayar"  type="date" required class="form-control" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Jumlah Bayar (Jumlah Yg Harus Dibayar Adalah <b><?= number_format($kekurangan,2,',','.') ?></b>)</label>
                    <input name="jumlah_bayar" type ="number" max="<?= $kekurangan; ?>" class="form-control" required>
                </div>
                <div class="form-group">
        ...
        <div class="card-footer">
                        <a href="pembayaran.php" class="btn btn-primary btn-icon-split">

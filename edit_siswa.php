<?php
    ...
    if(isset($_GET['hal'])){
        if($_GET['hal'] == "edit"){
            $tampil = mysqli_query($koneksi, "select * from siswa where nis = '$_GET[nis]'");
    ...
    if(isset($_POST['simpan'])){
        $simpan = mysqli_query($koneksi, "update siswa set
                                    ...
                                    jk = '$_POST[jk]' where nis = '$_GET[nis]'");
    if($simpan)
    {
        echo "<script>
...
<body id="page-top">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="dashboardd.php" data-toggle="modal" data-target="#logoutModal">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form  method="post">
                <div class="form-group">
                    <label>NIS</label>
                    <input name="nis" type="text" value="<?= $nis ?>" required class="form-control" placeholder="Masukan nis...">
                </div>
                <div class="form-group">
                    <label>Nama Siswa</label>
                    <input name="nama" type="text" value="<?= $nama ?>" required class="form-control" placeholder="Masukan Nama Siswa...">
                </div>
                <div class="form-group">
                    <label>Kelas</label>
                    <input name="kelas" type="text" value="<?= $kelas ?>" required class="form-control" placeholder="Masukan Nama Siswa...">
                </div>
                <div class="form-group">
                    ...
                    <option value="3">MULMED</option>
                    </select>
                </div>
                <div class="form-group">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" value="<?= $jk ?>" type="radio" name="jk" id="inlineRadio1" value="LAKI-LAKI">
                        <label class="form-check-label" for="inlineRadio1">Laki-Laki</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" value="<?= $jk ?>" type="radio" name="jk" id="inlineRadio2" value="PEREMPUAN">
        ...
        <div class="card-footer">
                        <a href="datasiswa.php" class="btn btn-primary btn-icon-split">

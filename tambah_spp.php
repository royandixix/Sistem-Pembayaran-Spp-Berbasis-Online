<?php
    ...
    if(isset($_POST['simpan'])){
        $simpan = mysqli_query($koneksi, "insert into spp (id_spp, semester, tahun, nominal)
                                    VALUES ('$_POST[id_spp]',
                                            '$_POST[semester]',
                                            '$_POST[tahun]',
                                            '$_POST[nominal]')
        ...
        <div class="card-body">
            <form  method="post">
                <div class="form-group">
                    <label>ID SPP</label>
                    <input name="id_spp" type="text" required class="form-control" placeholder="Masukan Id SPP...">
                </div>
                <div class="form-group">
                    <label>Semester</label>
                    <input name="semester" type="text" required class="form-control" placeholder="Masukan Semester...">
                </div>
                <div class="form-group">
                    <label>Tahun</label>
                    <input name="tahun" type="text" required class="form-control" placeholder="Masukan Tahun...">
                </div>
                <div class="form-group">
                    <label>Nominal</label>
                    <input name="nominal" type="number" required class="form-control" placeholder="Masukan Nominal...">
                </div>
                <div class="form-group">

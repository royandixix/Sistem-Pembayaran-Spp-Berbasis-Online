<?php
    ...
    if(isset($_POST['simpan'])){
        $simpan = mysqli_query($koneksi, "insert into siswa (nis, nama, kelas, jurusan, jk, id_spp)
                                    VALUES ('$_POST[nis]',
                                            '$_POST[nama]',
                                            '$_POST[kelas]',
                                            '$_POST[jurusan]',
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item ">
                ...
                <i class="fa fa-duotone fa-credit-card"></i>
                   <center> <span>PEMBAYARAN</span></a></center>
            </li>
            <li class="nav-item ">
        ...
        <div class="card-body">
            <form  method="post">
                <div class="form-group">
                    <label>NIS</label>
                    <input name="nis" type="text" required class="form-control" placeholder="Masukan nis...">
                </div>
                <div class="form-group">
                    <label>Nama Siswa</label>
                    <input name="nama" type="text" required class="form-control" placeholder="Masukan Nama Siswa...">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <select class="form-control" name="id_spp" aria-label="Default select example" required>
